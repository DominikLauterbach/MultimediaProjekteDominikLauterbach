...
void MenuState::init()
{
    ...
    if (!m_backgroundTexture.loadFromFile("../assets/Menubackground.jpeg"))
    {
    ...
    {
        btn->onClick([&manager = m_gameStateManager] { manager->setState("BindingState"); });
    }
}
...
void MenuState::update(float delta)
{
    ...
    {
        m_gameStateManager->setState("BindingState");
    }
}
